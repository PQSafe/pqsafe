...
[![Tests](https://img.shields.io/badge/tests-22%2F22-10b981)](agent-pay/tests/)
...
|---------|-------------|--------|
| [`agent-pay`](agent-pay/) | TypeScript SDK — envelopes, ML-DSA-65 signing, multi-rail execution | **Live** — 22/22 tests, Airwallex + Wise live, USDC-Base + x402 mock |
