...
[PQSafe AgentPay API Reference](../README.md) / verifyEnvelope

# Function: verifyEnvelope()

> **verifyEnvelope**(`signed`, `dsaPublicKey?`): `object`

Defined in: [agent-pay/src/envelope.ts:147](https://github.com/PQSafe/pqsafe/blob/bf2933a652d25995bb1e6fa114bf69715cac9034/agent-pay/src/envelope.ts#L147)
